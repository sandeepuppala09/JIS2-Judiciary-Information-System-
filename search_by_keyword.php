...
<body>
    ...
    <form action="search_by_keyword.php" method="post">
        <p>Search: <input type="text" name="key_word" id="key_word"> <button type="submit">search</button></p>
    </form>
    <div>
    <?php
    ...
    #session_start();
     ...
     if($_SERVER["REQUEST_METHOD"]='POST')
     {
      if(isset($_POST['key_word'])){
        ...
        $sql="SELECT * FROM NEWCASE WHERE crime_type LIKE '%$key_word%'OR name_of_defendent LIKE '%$key_word%' OR arresting_officer LIKE '%$key_word'";

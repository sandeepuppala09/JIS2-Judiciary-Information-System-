<?php
    session_start();
     ...
     $sql='SELECT DISTINCT NEWCASE.*,UPDATE_DETAILS.status FROM NEWCASE INNER JOIN UPDATE_DETAILS ON NEWCASE.CIN = UPDATE_DETAILS.CIN where UPDATE_DETAILS.status="solved" ORDER BY NEWCASE.start_date';
